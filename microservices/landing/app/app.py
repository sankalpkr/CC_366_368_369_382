...
def index():
    ...
    if(number_1 == ''):
        ...
        result = requests.get("http://modulus:5059/modulus/"+str(number_1)+"/"+str(number_2)).text
    elif operation == 'gcd':
        result = requests.get("http://gcd:5060/gcd/"+str(number_1)+"/"+str(number_2)).text 
    elif operation == 'gt':
        result = requests.get("http://gt:5061/gt/"+str(number_1)+"/"+str(number_2)).text
    elif operation == 'lt':
        result = requests.get("http://lt:5062/lt/"+str(number_1)+"/"+str(number_2)).text
